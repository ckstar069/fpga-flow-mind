...
| [`phase-9-implementation-plan.md`](phase-9-implementation-plan.md) | `draft` | Phase 9 编码实施计划：P9-T01~P9-T10 任务拆解、5 个 Batch（A~E）划分、进入/退出条件、安全边界、真实网络调用开关。**Phase 9 编码尚未开始；6 份详细文档转 active 前不得编码** | Phase 9 编码实施依据（draft，待审核） |
