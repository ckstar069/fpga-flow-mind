...
| [`phase-8-product-workbench-view.md`](phase-8-product-workbench-view.md) | `active` | Phase 8 产品级工作台 UI/UX：AgentScope 风格 9 条设计语言、三段式骨架、深色导航/浅色主区/顶部概览/中部筛选/可展开列表/卡片/蓝色强调、视觉语义系统、空/错误状态、文案规范 | Phase 8 前端编码前必读（active；当前仅允许进入 Batch A） |
