...
| [`phase-5-trace-and-qa-view.md`](phase-5-trace-and-qa-view.md) | `draft` | Phase 5 证据回链与 Grounded Q&A 前端设计：MultiViewPanel 选中态、TracePanel、SourceExcerptPanel、EvidencePanel 高亮、GroundedQAPanel、视觉语义 | Phase 5 前端编码前必读 |
