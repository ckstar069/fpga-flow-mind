...
| [`phase-2-evidence-view.md`](phase-2-evidence-view.md) | `draft` | Phase 2 evidence view 前端设计：EvidencePanel 组件、CollectEvidenceButton、统计概要、筛选栏、证据项卡片、警告列表、状态管理、前后端边界 | Phase 2 前端编码前必读 |
