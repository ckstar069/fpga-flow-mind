...
| [`phase-9-llm-configuration-and-grounded-qa-view.md`](phase-9-llm-configuration-and-grounded-qa-view.md) | `draft` | Phase 9 LLM 配置与 Grounded Q&A 视图：最小 Provider 配置入口、provider=mock/real/degraded 状态可见、配置字段与安全文案、Q&A/understanding 体验、错误/degraded 态、不裁决化、延续 Phase 8 视觉 | Phase 9 前端编码前必读（**draft；Phase 9 编码尚未开始，未接入真实 LLM**） |
