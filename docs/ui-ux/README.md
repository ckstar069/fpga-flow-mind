...
| [`phase-7-quality-review-view.md`](phase-7-quality-review-view.md) | `draft` | Phase 7 Quality Review 视图设计：仅做质量评估视图不做工作台重构、Quality Review 面板/issue list/stage quality summary/各面板最小质量提示/验收清单视图、视觉语义、文案规范 | Phase 7 前端编码前必读（当前 draft，未进入编码） |
