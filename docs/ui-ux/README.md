...
| [`phase-4-multi-view-panel.md`](phase-4-multi-view-panel.md) | `draft` | Phase 4 三视图面板前端设计：MultiViewPanel 布局、Tab bar（结构图/数据流/时序流水）、SVG 渲染方案、节点/边颜色形状置信度编码、hover tooltip、空状态、交互规范 | Phase 4 前端编码前必读 |
