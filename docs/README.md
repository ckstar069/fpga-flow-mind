...
3. `docs/planning/phase-8-overview-product-ui-workbench.md`（Phase 8 overview：产品级 UI 工作台重构，draft）
   - Phase 8 详细文档（**均已 `active`；Phase 8 编码已完成，Batch A/B/C/D 已完成，Batch E 中 P8-T10 待真实桌面验收，[completion review](planning/phase-8-completion-review.md) 仍为 draft / pending_desktop_acceptance；Phase 9 未开始**）：
