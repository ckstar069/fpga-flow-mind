...
| [`phase-4-view-validation.md`](phase-4-view-validation.md) | `draft` | Phase 4 视图验证设计：后端 ViewGraph 生成测试（~36 个）、前端渲染验证、hover tooltip、空状态/degraded、安全回归、桌面验收 8 步骤 | Phase 4 验证与验收依据 |
