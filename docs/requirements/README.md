...
| [`phase-4-view-requirements.md`](phase-4-view-requirements.md) | `draft` | Phase 4 三类视图展示需求：功能点 SV-001~SV-005、StructureView/DataflowView/TimingView、证据追溯、空状态、非目标 | Phase 4 设计和实施前必读 |
