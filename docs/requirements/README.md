...
| [`phase-7-real-project-quality-requirements.md`](phase-7-real-project-quality-requirements.md) | `active` | Phase 7 真实项目评估与 evidence/understanding 质量补强需求：RQ-001~RQ-008、真实项目样本覆盖、非目标、退出标准。**Phase 7 文档已 active，编码尚未开始** | Phase 7 设计和实施前必读（active；允许进入 Batch A） |
