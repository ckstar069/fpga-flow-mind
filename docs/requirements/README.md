...
| [`phase-8-product-workbench-requirements.md`](phase-8-product-workbench-requirements.md) | `active` | Phase 8 产品级工作台需求：R8-001~R8-010、AgentScope 风格信息架构细化、异常/空状态、退出标准、非目标 | Phase 8 设计和实施前必读（active；当前仅允许进入 Batch A） |
