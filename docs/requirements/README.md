...
| [`phase-7-real-project-quality-requirements.md`](phase-7-real-project-quality-requirements.md) | `draft` | Phase 7 真实项目评估与 evidence/understanding 质量补强需求：RQ-001~RQ-008、真实项目样本覆盖、非目标、退出标准。**Phase 7 未进入编码，详细文档当前均为 draft** | Phase 7 设计和实施前必读（当前 draft，待审核转 active 后方可编码） |
