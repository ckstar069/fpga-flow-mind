...
| [`phase-5-trace-and-qa-requirements.md`](phase-5-trace-and-qa-requirements.md) | `draft` | Phase 5 证据回链与 grounded Q&A 需求：F5-001~F5-008、trace 选择模型、source excerpt、Grounded Q&A、安全边界、非目标 | Phase 5 设计和实施前必读 |
